document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            'hero-title': 'Senior Accountant | Accounting Manager',
            'hero-usp': 'Results-driven Senior Accountant and Accounting Manager with 5+ years of progressive experience in full-cycle accounting, financial reporting, and ERP systems implementation.',
        ...
        ar: {
            ...
            'hero-title': 'محاسب أول | مدير حسابات',
            'hero-usp': 'محاسب أول ومدير حسابات يركز على النتائج ويتمتع بخبرة تزيد عن 5 سنوات في المحاسبة الشاملة والتقارير المالية وتنفيذ أنظمة ERP.',
